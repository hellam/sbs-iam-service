...
public class BackofficeBranchController {
    ...
    public ResponseEntity<ApiResponse<Page<BranchResponse>>> getAllBranches(
        ...
        Page<BranchResponse> response = branches.map(BranchMapper::toInternalResponse);
    ...
    public ResponseEntity<ApiResponse<BranchResponse>> getBranchById(@PathVariable Long id) {
        ...
        BranchResponse response = BranchMapper.toInternalResponse(branch);
        return ResponseBuilder.success(response);
    }
    ...
    public ResponseEntity<ApiResponse<BranchResponse>> createBranch(@Valid @RequestBody BranchRequest request) {
        ...
        BranchResponse response = BranchMapper.toInternalResponse(createdBranch);
    ...
    public ResponseEntity<ApiResponse<BranchResponse>> updateBranch(
        ...
        BranchResponse response = BranchMapper.toInternalResponse(updatedBranch);
